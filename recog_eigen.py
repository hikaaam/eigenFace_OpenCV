...
class RecogEigenFaces:
    ...
    def process_image(self, inImg):
        ...
        gray_resized = cv2.resize(gray, (round(gray.shape[1]/RESIZE_FACTOR), round(gray.shape[0]/RESIZE_FACTOR)))        
        ...
        for i in range(len(faces)):
            ...
            if confidence[1]<3500:
                ...
                cv2.putText(frame, '%s - Confidence : %.0f' % (person, confidence[1]), (x-10, y-10), cv2.FONT_HERSHEY_PLAIN,1,(0, 255, 0))
            else:
                person = 'Unknown'
